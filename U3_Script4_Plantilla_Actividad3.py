...
A_UB   = [
    [0.275, 0.215],                             # ← Restricción 1
    [100, 200],                             # ← Restricción 2
]

# Lado derecho de cada restricción (RHS)
B_UB   = [30.00, 10000.00]                    # ← [b₁, b₂]

# Nombres descriptivos (para tablas y gráficas)
NOMBRE_R = ["presupuesto($)",          # ← nombre restricción 1
            "Aceite (ml)"]              # ← nombre restricción 2

NOMBRE_X = ["Mollejitas",  "Hígado"]            # ← nombre variable 1 y 2
UNIDAD_X = ["porciones",  "porciones"]             # ← unidad de medida
...
DELTA_RHS  = np.arange(25.00, 35.01, 1.0)      # ← ajusta según tu problema

# Rango de variación de c₁ para la sensibilidad de coeficientes
C1_RANGO   = np.arange(0.5, 0.6, 0.01)          # ← ajusta según tu problema
